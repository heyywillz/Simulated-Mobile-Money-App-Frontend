...
export function hasNativeFaceDetector() {
...
export class RealtimeFaceTracker {
  constructor(video, canvasOverlay, options) {
    this.video = video;
      ...
      try {
        ...
        if (faces && faces.length > 0) {
          ...
          if (f.landmarks && f.landmarks.length > 0) {
            let leftEye = { x: b.x + b.width * 0.32, y: b.y + b.height * 0.38 };
            let rightEye = { x: b.x + b.width * 0.68, y: b.y + b.height * 0.38 };
            let nose = { x: b.x + b.width * 0.5, y: b.y + b.height * 0.54 };
            let mouth = { x: b.x + b.width * 0.5, y: b.y + b.height * 0.76 };
  ...
  renderOverlay(result) {
    ...
    if (result.landmarks) {
      ...
      drawPoint(lm.leftEye);
      drawPoint(lm.rightEye);
      drawPoint(lm.nose);
      drawPoint(lm.mouth);
