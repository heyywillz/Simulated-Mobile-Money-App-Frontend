 ...
 */
export function detectOperatingSystem(ua, platformStr = '') {
 ...
 */
export function getExactDeviceDetails() {
  ...
  const cpuCores = typeof navigator !== 'undefined' ? navigator.hardwareConcurrency : 8;
  const memoryGb = typeof navigator !== 'undefined' ? navigator.deviceMemory : 8;
 ...
 */
export function generateDeviceProfile(platform) {
 ...
 */
export function storeDeviceProfile(profile) {
 ...
 */
export function generateEnrichedDeviceProfile(platform) {
